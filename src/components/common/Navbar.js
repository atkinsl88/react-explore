      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item active">
            <Link className="nav-link" to="/lorem-ipsum">Lorem Ipsum<span className="sr-only">(current)</span></Link>
          </li>
          ...
          <li className="nav-item">
            <Link className="nav-link" to="/lacus-tincidunt">Lacus Tincidunt</Link>
          </li>
        </ul>
      </div>
    </nav>
